...
# %% auto 0
__all__ = ['lagr_identity', 'lagr_repu', 'lagr_relu', 'lagr_softmax', 'lagr_softmax_unstable', 'lagr_exp', 'lagr_rexp',
           'lagr_tanh', 'lagr_sigmoid', 'lagr_layernorm', 'lagr_spherical_norm', 'LIdentity', 'LRepu', 'LRelu',
           'LSigmoid', 'LSoftmax', 'LSoftmaxUnstable', 'LExp', 'LRexp', 'LTanh', 'LLayerNorm', 'LSphericalNorm']
