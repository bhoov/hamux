...
![HAMUX Logo](https://github.com/bhoov/hamux/blob/main/nbs/figures/HAMUX-header.png?raw=true)
...
![**HAMUX is a [hypergraph](https://en.wikipedia.org/wiki/Hypergraph) of 🌀neurons connected via 🤝hypersynapses**, an abstraction sufficiently general to model any conceivable Associative Memory.](./figures/hamux_overview.png)

See our walkthrough in [this notebook](./00_core.ipynb) for a more detailed explanation of how everything works. 
